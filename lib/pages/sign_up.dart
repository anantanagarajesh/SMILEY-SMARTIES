            ...
            Positioned(
              ...
              child: Container(
                ...
                child: SizedBox(
                  ...
                  height: 516,
                  child: Container(
                    padding: EdgeInsets.fromLTRB(20, 0, 21, 35),
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(2, 0, 2, 11),
                          child: Align(
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(4, 0, 0, 6),
                          decoration: BoxDecoration(
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(5, 0, 5, 6),
                          child: Align(
                            alignment: Alignment.topLeft,
                            child: Text(
                              'Password',
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(4.3, 0, 4.3, 7),
                          child: Align(
                            alignment: Alignment.topLeft,
                            child: Text(
                              'Confirm Password',
