...
class Questions8 extends StatelessWidget {
  @override
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                        ...
                        child: ClipRRect(
                          ...
                          child: SizedBox(
                            ...
                            child: SvgPicture.asset(
                              'assets/vectors/rectangle_46_x2.svg',
                            ),
                          ),
                        ),
                      ),
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(89, 0, 0, 7),
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color(0x1AFFFFFF),
                      borderRadius: BorderRadius.circular(22.5),
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(33, 0, 33, 22),
                  child: Align(
                    alignment: Alignment.topLeft,
                    child: SizedBox(
                      width: 317,
                      child: Container(
                        padding: EdgeInsets.fromLTRB(8, 0, 8, 93),
                        child: Stack(
                          clipBehavior: Clip.none,
                          children: [
                            Positioned(
